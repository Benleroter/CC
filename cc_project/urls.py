...
Including another URLconf
    ...
    2. Add a URL to urlpatterns:  path('candidates/', include('candidates.urls'))
"""
...
urlpatterns = [
    ...
    path('clientprofileview/', user_views.clientprofileview, name='clientprofileview'),
    path('', auth_views.LoginView.as_view(template_name='clients/welcome.html'), name='welcome'),
